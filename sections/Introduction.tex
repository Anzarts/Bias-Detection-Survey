...
Social bias can ogirinate and be a consequence of prediction bias, but prediction bias does not implicate social bias. We provide further discussion and previously definitions of the concept of prediction bias in Section \ref{sec:bias}. Figure \ref{fig:bias-diagram} ilustrates de application of both terms.
